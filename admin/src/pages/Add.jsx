  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
              <p className='mb-2'>Available Day</p>
              <select onChange={(e) => setCategory(e.target.value)} className='w-full px-3 py-2'>
                  <option value="Furnitures">Sunday</option>
                  <option value="Textures">Monday</option>
                  <option value="Home Decor">Tuesday</option>
                  <option value="Home Decor">Wednesday</option>
                  <option value="Home Decor">Friday</option>
                  <option value="Home Decor">Saturday</option>
              </select>
            </div>
            ...
            <div>
              <p className='mb-2'>Session Price</p>
